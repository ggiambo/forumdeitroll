...
CREATE CACHED TABLE PUBLIC.ADS (
...
CREATE CACHED TABLE PUBLIC.BOOKMARKS (
  NICK TINYTEXT NOT NULL,
  MSGID INT NOT NULL,
  SUBJECT TINYTEXT NOT NULL
);

CREATE CACHED TABLE PUBLIC.DIGEST (
...
CREATE CACHED TABLE PUBLIC.DIGEST_PARTICIPANT (
  THREADID INT DEFAULT NULL,
  AUTHOR VARCHAR(256)
);
...
CREATE CACHED TABLE PUBLIC.TAGNAMES (
	T_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	VALUE TINYTEXT NOT NULL,
);

CREATE CACHED TABLE PUBLIC.TAGS_BIND (
	T_ID INT NOT NULL,
	M_ID INT NOT NULL,
	AUTHOR VARCHAR(256) NOT NULL,
...
CREATE CACHED TABLE PUBLIC.THREADS (
    THREADID INT NOT NULL,
    LASTID INT NOT NULL,
);
...
CREATE INDEX FORUM_IDX ON MESSAGES(FORUM);
...
CALL FT_CREATE_INDEX('PUBLIC', 'MESSAGES', 'TEXT,SUBJECT');
