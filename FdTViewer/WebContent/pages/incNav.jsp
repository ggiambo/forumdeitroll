...
<div id="nav">
	...
	<ul>
		...
		<li><a id=ciattina href="Minichat" onclick="window.open('Minichat', 'la ciattina', 'left=100px,top=100px,height=600px,width=400px,menubar=no,toolbar=no,location=no,status=no'); return false;">la ciattina</a></li>
		<c:if test="${not empty loggedUser}">
			<fdt:delayedScript>
				(function() {
